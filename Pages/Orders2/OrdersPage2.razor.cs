...
namespace LAGem_POPortal.Orders2
{
    public partial class OrdersPage2 : ComponentBase
    {
        // ============================================================ \\
        ...
        //Dictionary<string, string[]> GroupInfo { get; } = new Dictionary<string, string[]> {
        //    { "ShipWindow", new string[] { "ShipWindow" } },
        //    { "ShipWindow, MondayOfTheWeek", new string[] { "ShipWindow", "MondayOfTheWeek" } }
        //};
        //string CurrentGroupInfoKey { get; set; } = "ShipWindow";
