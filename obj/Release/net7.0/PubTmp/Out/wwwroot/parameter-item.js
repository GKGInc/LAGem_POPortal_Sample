(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === "object" && typeof module === "object")
        module.exports = factory(require("devexpress-dashboard/model")
            , require("devexpress-dashboard/designer")
            , require("devexpress-dashboard/common")
            , require("devextreme/ui/button"));
    else if (typeof define === "function" && define.amd)
        define(["devexpress-dashboard/model", "devexpress-dashboard/designer", "devexpress-dashboard/common", "devextreme/ui/button"], factory);
    else {
        var a = typeof exports === "object" ? factory(require("devexpress-dashboard/model")
            , require("devexpress-dashboard/designer")
            , require("devexpress-dashboard/common")
            , require("devextreme/ui/button")) : factory(root["DevExpress"]["Dashboard"]["Model"], root["DevExpress"]["Dashboard"]["Designer"], root["DevExpress"]["Dashboard"], root["DevExpress"]["ui"]["dxButton"]);
    ...
    return function (modules) {
        ...
        //var SaveAsDashboardExtension = function () {
        //    //toolbox;
        //    //menuItem;
        //    //dashboardControl;
